...
> 模块编号: 72-container-orchestration
> 主题: 容器编排
> 最后更新: 2026-04-27

## 模块概述

本模块深入探讨 **容器编排**，涵盖核心理论、设计模式与可运行的 TypeScript 代码实现。

Docker、Kubernetes 与云原生部署。通过本模块你将系统掌握从基础概念到工程实践的完整知识体系。
