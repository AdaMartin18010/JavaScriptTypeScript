...
- [现代认证专题文档](../../../30-knowledge-base/30.2-categories/29-authentication.md) — 完整的方案对比与选型指南
- [Passkeys 深度实现指南](../../../30-knowledge-base/30.2-categories/29-authentication.md#8-passkeys--webauthn-深度实现指南)
