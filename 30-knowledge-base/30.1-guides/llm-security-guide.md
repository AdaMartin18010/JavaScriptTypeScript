<!--
# 合并说明
- 合并来源: docs/guides/llm-security-guide.md（完整版，1207 行）、30-knowledge-base/30.1-guides/llm-security-guide.md（精简版，151 行）
...
- [LLM 应用安全完全指南](#llm-应用安全完全指南)
  ...
  - [7. AI 应用安全 Checklist](#7-ai-应用安全-checklist)
    ...
    - [7.4 数据层](#74-数据层)
    - [7.5 监控与响应](#75-监控与响应)
  - [8. AI 供应链安全](#8-ai-供应链安全)
    - [8.1 模型投毒 (Model Poisoning)](#81-模型投毒-model-poisoning)
    - [8.2 依赖漏洞](#82-依赖漏洞)
    - [8.3 SBOM (软件物料清单)](#83-sbom-软件物料清单)
  - [9. 参考资源](#9-参考资源)
