...
- [后端框架分类](../30.2-categories/14-backend-frameworks.md) — 基于 Node.js 的后端框架选型
- [ORM 与数据库分类](../30.2-categories/11-orm-database.md) — 数据库操作层工具
- [部署与托管平台分类](../30.2-categories/26-deployment-hosting.md) — Node.js 应用部署目标
- [CI/CD 工具对比矩阵](../30.3-comparison-matrices/ci-cd-tools-compare.md) — 自动化构建与部署流水线
