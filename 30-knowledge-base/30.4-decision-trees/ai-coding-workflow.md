...
## 七、代码示例：AI 辅助 API 脚手架生成与验证

```typescript
// ai-generated-api.ts — 示例：AI 生成的 NestJS 风格 API 模块
// 人工审查要点：验证 DTO 约束、异常处理、权限装饰器

import { Controller, Get, Post, Body, Param, ParseIntPipe, UseGuards } from '@nestjs/common';
import { ZodValidationPipe } from 'nestjs-zod';
import { z } from 'zod';

// AI 生成的 Zod Schema — 人工需验证业务规则完整性
...
@Controller('users')
@UseGuards(AuthGuard) // 人工确认：AI 是否正确应用了权限守卫
...
- [Continue.dev 开源扩展](https://continue.dev/)
- [Aider (开源 CLI)](https://aider.chat/)
- [Ollama 本地模型](https://ollama.com/)
- [CodeRabbit AI 代码审查](https://coderabbit.ai/)
- [PR-Agent (开源)](https://github.com/Codium-ai/pr-agent)
- [Semgrep 安全扫描](https://semgrep.dev/)
- [CodeQL 静态分析](https://codeql.github.com/)
- [FOSSA 许可证合规](https://fossa.com/)
- [Snyk 安全平台](https://snyk.io/)
- [GitHub Copilot 数据处理条款](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement)
...
- [Node.js clinic.js 性能诊断](https://clinicjs.org/)

---

*本指南基于 2026 年 AI 编码工具生态现状，建议每季度更新工具对比数据。*
