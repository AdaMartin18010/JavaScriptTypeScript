...
# 检查特定包的依赖树
pnpm why lodash --filter @repo/core

# 运行 affected 测试（Turborepo）
pnpm turbo run test --filter=[main...HEAD]

# Nx 模块边界检查
nx enforce-module-boundaries --projects=core
```
...
| 资源 | 链接 | 说明 |
|------|------|------|
| Nx Cloud | <https://nx.dev/nx-cloud> | 分布式缓存与 CI 优化 |
| Bazel Docs | <https://bazel.build/docs> | Google 构建系统文档 |
| pnpm Catalogs | <https://pnpm.io/catalogs> | 依赖 catalog 协议 |
| Turborepo Remote Cache | <https://turbo.build/repo/docs/core-concepts/remote-caching> | 远程缓存配置 |
| Moonrepo Docs | <https://moonrepo.dev/docs> | Rust 编写构建工具 |
| Nx Module Boundaries | <https://nx.dev/features/enforce-module-boundaries> | 模块依赖规则 |
| Git Subtree | <https://git-scm.com/book/en/v2/Git-Tools-Advanced-Merging> | 仓库合并保留历史 |
| Semantic Versioning | <https://semver.org/lang/zh-CN/> | Semver 中文规范 |
