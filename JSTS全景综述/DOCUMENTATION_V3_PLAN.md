...
> 时间基准：2026 年 4 月 2 日
> 策略：文档优先，代码暂缓；建立"规范 + 实现 + 学术"三位一体的深度分析。
...
- [ ] 所有涉及 TC39 提案状态的描述，必须对照 **2025–2026 年 TC39 proposals 仓库** 更新为准确阶段
- [ ] 所有 TypeScript 版本特性，必须标注到 **5.9 / 6.0 / 7.0 预览**
- [ ] 所有 Node.js 特性，必须对齐 **Node.js 20 LTS / 22 / 24** 三个版本线
