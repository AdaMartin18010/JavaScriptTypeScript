...
- [JavaScript/TypeScript 日期时间处理完全指南](#javascripttypescript-日期时间处理完全指南)
  - [目录](#目录)
  - [1. JavaScript Date 对象深入解析](#1-javascript-date-对象深入解析)
    - [1.1 核心概念](#11-核心概念)
    - [1.2 创建 Date 对象](#12-创建-date-对象)
    - [1.3 获取时间信息](#13-获取时间信息)
    - [1.4 修改 Date 对象](#14-修改-date-对象)
    - [1.5 字符串转换](#15-字符串转换)
    - [1.6 最佳实践](#16-最佳实践)
  - [2. 时区处理理论](#2-时区处理理论)
    - [2.1 时区基础概念](#21-时区基础概念)
    - [2.2 时区表示方式](#22-时区表示方式)
    - [2.3 UTC 与本地时间转换](#23-utc-与本地时间转换)
    - [2.4 时区感知日期操作](#24-时区感知日期操作)
    - [2.5 常见时区处理场景](#25-常见时区处理场景)
    - [2.6 时区处理最佳实践](#26-时区处理最佳实践)
  - [3. Temporal API 提案详解](#3-temporal-api-提案详解)
    - [3.1 Temporal 简介](#31-temporal-简介)
    - [3.2 核心类型](#32-核心类型)
    - [3.3 Temporal 实用操作](#33-temporal-实用操作)
    - [3.4 Temporal 与 Date 互操作](#34-temporal-与-date-互操作)
    - [3.5 Temporal 最佳实践](#35-temporal-最佳实践)
  - [4. 日期库对比](#4-日期库对比)
    - [4.1 库概览](#41-库概览)
    - [4.2 代码对比示例](#42-代码对比示例)
    - [4.3 date-fns 详解](#43-date-fns-详解)
    - [4.4 Day.js 详解](#44-dayjs-详解)
    - [4.5 Luxon 详解](#45-luxon-详解)
    - [4.6 库选择建议](#46-库选择建议)
  - [5. 常见日期操作](#5-常见日期操作)
    - [5.1 解析操作](#51-解析操作)
    - [5.2 格式化操作](#52-格式化操作)
    - [5.3 计算操作](#53-计算操作)
    - [5.4 比较操作](#54-比较操作)
    - [5.5 实用工具函数](#55-实用工具函数)
  - [6. 日历计算](#6-日历计算)
    - [6.1 闰年判断](#61-闰年判断)
    - [6.2 月份天数](#62-月份天数)
    - [6.3 周计算](#63-周计算)
    - [6.4 季度和半年计算](#64-季度和半年计算)
  - [7. 夏令时处理](#7-夏令时处理)
    - [7.1 夏令时概念](#71-夏令时概念)
    - [7.2 检测夏令时](#72-检测夏令时)
    - [7.3 夏令时边界处理](#73-夏令时边界处理)
    - [7.4 夏令时最佳实践](#74-夏令时最佳实践)
  - [8. 国际化日期格式](#8-国际化日期格式)
    - [8.1 Intl.DateTimeFormat 基础](#81-intldatetimeformat-基础)
    - [8.2 相对时间格式化](#82-相对时间格式化)
    - [8.3 持续时间格式化](#83-持续时间格式化)
    - [8.4 列表格式化](#84-列表格式化)
    - [8.5 完整国际化封装](#85-完整国际化封装)
  - [9. 日期范围查询和分页](#9-日期范围查询和分页)
    - [9.1 日期范围构建](#91-日期范围构建)
    - [9.2 分页查询](#92-分页查询)
    - [9.3 日期范围数据库查询](#93-日期范围数据库查询)
    - [9.4 时间序列聚合](#94-时间序列聚合)
  - [10. 时间戳和性能计时](#10-时间戳和性能计时)
    - [10.1 Date.now() 与性能时间](#101-datenow-与性能时间)
    - [10.2 Performance API](#102-performance-api)
    - [10.3 高精度计时器](#103-高精度计时器)
    - [10.4 时间戳最佳实践](#104-时间戳最佳实践)
  - [附录](#附录)
    - [A. 常见日期库安装](#a-常见日期库安装)
    - [B. 参考资源](#b-参考资源)
