...
> 模块编号: 32-edge-computing
> 主题: 边缘计算
> 最后更新: 2026-04-27

## 模块概述

本模块深入探讨 **边缘计算**，涵盖核心理论、设计模式与可运行的 TypeScript 代码实现。

CDN 边缘、V8 Isolate、Durable Objects 与边缘架构。通过本模块你将系统掌握从基础概念到工程实践的完整知识体系。
