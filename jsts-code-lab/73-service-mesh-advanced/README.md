...
> 模块编号: 73-service-mesh-advanced
> 主题: 高级服务网格
> 最后更新: 2026-04-27

## 模块概述

本模块深入探讨 **高级服务网格**，涵盖核心理论、设计模式与可运行的 TypeScript 代码实现。

Istio、Linkerd 与服务间通信治理。通过本模块你将系统掌握从基础概念到工程实践的完整知识体系。
