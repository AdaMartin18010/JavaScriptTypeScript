import{_ as o,o as s,c as t,j as e,a as r}from"./chunks/framework.DGDNmojq.js";const u=JSON.parse('{"title":"Event Loop 架构对比 - Browser vs Node.js vs Worker","description":"","frontmatter":{"title":"Event Loop 架构对比 - Browser vs Node.js vs Worker"},"headers":[],"relativePath":"diagrams/event-loop-comparison.md","filePath":"diagrams/event-loop-comparison.md","lastUpdated":1776456138000}'),a={name:"diagrams/event-loop-comparison.md"};function c(i,n,l,_,d,N){return s(),t("div",null,[...n[0]||(n[0]=[e("p",null,[r('flowchart TB subgraph Browser["🌐 Browser Event Loop"] B_Macro["Macrotask Queue'),e("br"),r('(Task Queue)"] B_Micro["Microtask Queue'),e("br"),r('(Promise, queueMicrotask)"] B_Render["Render Steps'),e("br"),r('RAF, Style, Layout, Paint"] B_Exec["JavaScript Execution"]')],-1),e("pre",null,[e("code",null,`    B_Exec -->|"执行完当前任务"| B_Micro
...
`)],-1)])])}const M=o(a,[["render",c]]);export{u as __pageData,M as default};
