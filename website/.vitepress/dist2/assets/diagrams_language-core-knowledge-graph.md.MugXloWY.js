import{_ as s,o as t,c as n,j as _}from"./chunks/framework.DGDNmojq.js";const b=JSON.parse('{"title":"JavaScript/TypeScript 语言核心知识图谱","description":"","frontmatter":{"title":"JavaScript/TypeScript 语言核心知识图谱"},"headers":[],"relativePath":"diagrams/language-core-knowledge-graph.md","filePath":"diagrams/language-core-knowledge-graph.md","lastUpdated":1776545344000}'),c={name:"diagrams/language-core-knowledge-graph.md"};function a(r,e,m,o,p,l){return t(),n("div",null,[...e[0]||(e[0]=[_("p",null,'graph TD %% ========== 根节点 ========== root["🧠 JS/TS Language Core"]',-1),_("pre",null,[_("code",null,`%% ========== 第一层分支 ==========
es["📜 ECMAScript 演进"]
ts["🔷 TypeScript 类型系统"]
rt["⚙️ 运行时语义"]
cmp["🛠️ 编译与工具"]
...
`)],-1)])])}const i=s(c,[["render",a]]);export{b as __pageData,i as default};
