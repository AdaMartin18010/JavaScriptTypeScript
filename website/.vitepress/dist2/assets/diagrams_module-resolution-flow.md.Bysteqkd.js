import{_ as t,o as r,c as S,j as e,a as o}from"./chunks/framework.DGDNmojq.js";const p=JSON.parse('{"title":"ESM/CJS 模块解析与互操作流程","description":"","frontmatter":{"title":"ESM/CJS 模块解析与互操作流程"},"headers":[],"relativePath":"diagrams/module-resolution-flow.md","filePath":"diagrams/module-resolution-flow.md","lastUpdated":1776456138000}'),_={name:"diagrams/module-resolution-flow.md"};function a(l,n,s,M,d,E){return r(),S("div",null,[...n[0]||(n[0]=[e("p",null,[o('flowchart TD Start(["开始导入'),e("br"),o('import / require"])')],-1),e("pre",null,[e("code",null,`subgraph Detection["模块类型检测"]
...
`)],-1)])])}const C=t(_,[["render",a]]);export{p as __pageData,C as default};
