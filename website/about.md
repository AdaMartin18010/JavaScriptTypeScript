...
title: 关于
editLink: true
description: "关于 Awesome JS/TS Ecosystem 项目：使命、数据指标、分类体系、贡献指南与路线图"
head:
  - - meta
    - property: og:title
      content: "关于 | Awesome JS/TS Ecosystem"
  - - meta
    - property: og:description
      content: "Awesome JS/TS Ecosystem 是最全面的 TypeScript/JavaScript 学习知识体系，覆盖 800+ 文档页面"
---
...
```mermaid
graph TD
    A[Awesome JS/TS Ecosystem] --> B[10-理论基础]
    A --> C[20-代码实验室]
    A --> D[30-知识库]
    A --> E[40-生态趋势]
    A --> F[50-示例]
