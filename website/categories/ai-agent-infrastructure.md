...
| 模块 | 成熟度 | 说明 | 源码 |
|------|--------|------|------|
| 33-ai-integration | 🌿 可用 | AI SDK 封装、Prompt 工程、Embedding 流水线、流式输出、LLM 网关 | [查看](../../jsts-code-lab/33-ai-integration/) |
| 55-ai-testing | 🌳 成熟 | AI 辅助测试生成、视觉回归、LLM-as-a-Judge | [查看](../../jsts-code-lab/55-ai-testing/) |
| 82-edge-ai | 🌳 成熟 | 边缘推理、模型量化、联邦学习、WebGPU 计算 | [查看](../../jsts-code-lab/82-edge-ai/) |
| 94-ai-agent-lab | 🌿 可用 | MCP Server、多 Agent 协调、记忆层、工具注册中心 | [查看](../../jsts-code-lab/94-ai-agent-lab/) |
