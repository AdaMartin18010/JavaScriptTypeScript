...
description: TanStack Start 全栈框架概述、与 Next.js/Nuxt 的对比矩阵、以及适用场景决策树
---
...
export const getMessage = createServerFn({ method: 'GET' })
  .handler(async () => {
    return { message: 'Hello from Server Function!' }
  })
...
| 趋势 | 描述 |
|------|------|
| **稳定版发布** | TanStack Start 预计 2026 年中发布 1.0 稳定版 |
| **RSC 支持** | 计划支持 React Server Components |
