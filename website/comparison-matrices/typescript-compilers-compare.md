...
> 最后更新: 2026-05-02 | 覆盖: 类型检查 / 转译 / 压缩 / 格式化全链路
...
|--------|------|:--------:|:--------:|:--------:|----------|-------|
| **tsc** | JS/TS | ✅ 完整 | 基准 1x | 高 | 稳定 | 109k+ |
| **tsgo** | Go | ⚠️ Alpha 阶段 | **10-30x** | 高 | Alpha (2026 Q2) | - |
| **SWC** | Rust | ❌ (用 tsc) | **20x** | 高 | 成熟 | 33k+ |
| **esbuild** | Go | ❌ (用 tsc) | **50x** | 中 | 稳定 | 40k+ |
| **Babel** | JS | ❌ (用 tsc) | 10x | 高 | 维护模式 | 44k+ |
| **Oxc** | Rust | ⚠️ 开发中 | **~30x** | 高 | Beta | 21k+ |
