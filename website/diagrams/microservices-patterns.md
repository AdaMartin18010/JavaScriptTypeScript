...
flowchart TB
    ...
    class DB_A,DB_B,DB_C,Cache_A,Cache_B,Cache_C data
    class MB,MBFunc,PubSub,CQRS,Saga,ES event
    class Logs,Metrics,Traces observe
    class K8s,Registry,Secrets infra
    class Web,Mobile,ThirdParty,IoT client
```
