...
description: "Awesome JS/TS Ecosystem 指南: CSS-in-JS 完整指南"
---
...
- [CSS-in-JS 完整指南](#css-in-js-完整指南)
  - [目录](#目录)
  - [1. CSS-in-JS 理论基础](#1-css-in-js-理论基础)
    - [1.1 样式封装原理](#11-样式封装原理)
      - [传统 CSS 的问题](#传统-css-的问题)
      - [CSS-in-JS 的解决方案](#css-in-js-的解决方案)
      - [封装层级对比](#封装层级对比)
    - [1.2 运行时 vs 构建时](#12-运行时-vs-构建时)
      - [运行时方案（如 styled-components）](#运行时方案如-styled-components)
      - [构建时方案（如 Linaria、Twin.macro）](#构建时方案如-linariatwinmacro)
      - [性能对比示例](#性能对比示例)
    - [1.3 哈希生成策略](#13-哈希生成策略)
      - [自定义哈希生成](#自定义哈希生成)
  - [2. styled-components 深度指南](#2-styled-components-深度指南)
    ...
    - [2.2 主题系统](#22-主题系统)
      - [定义主题类型和实现](#定义主题类型和实现)
      - [主题 Provider 和类型声明](#主题-provider-和类型声明)
      - [使用主题的组件](#使用主题的组件)
    - [2.3 全局样式](#23-全局样式)
    - [2.4 动画支持](#24-动画支持)
    - [2.5 TypeScript 支持](#25-typescript-支持)
      - [完整的类型定义示例](#完整的类型定义示例)
  - [3. Emotion 深度指南](#3-emotion-深度指南)
    - [3.1 css prop](#31-css-prop)
    - [3.2 styled API](#32-styled-api)
    - [3.3 缓存策略](#33-缓存策略)
      - [缓存调试和优化](#缓存调试和优化)
    - [3.4 服务端渲染](#34-服务端渲染)
      - [流式 SSR 支持](#流式-ssr-支持)
  - [4. Tailwind CSS 方法论](#4-tailwind-css-方法论)
    ...
    - [4.3 自定义插件](#43-自定义插件)
      - [高级插件示例](#高级插件示例)
    - [4.4 JIT 模式](#44-jit-模式)
  - [5. CSS Modules](#5-css-modules)
    - [5.1 局部作用域](#51-局部作用域)
    - [5.2 组合策略](#52-组合策略)
    - [5.3 :global 和 :local](#53-global-和-local)
  - [6. 样式性能优化](#6-样式性能优化)
    - [6.1 关键 CSS 提取](#61-关键-css-提取)
    - [6.2 代码分割](#62-代码分割)
    - [6.3 样式重复检测](#63-样式重复检测)
  - [7. 设计令牌 Design Tokens](#7-设计令牌-design-tokens)
    - [7.1 理论基础](#71-理论基础)
    - [7.2 Style Dictionary](#72-style-dictionary)
      - [令牌源文件](#令牌源文件)
    - [7.3 主题切换](#73-主题切换)
      - [CSS 变量主题切换](#css-变量主题切换)
  - [总结](#总结)
