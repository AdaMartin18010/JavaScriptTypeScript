...
|:---|:---|:---|:---|:---|
| Svelte 版本更新 | 每月 | 新 Release | **01**, 21, 22, 23, 24, 25 | 复核源码行号；01 含编译器四阶段解析 |
| TC39 提案进展 | 每季度 | 会议记录 | 21 | 更新 Stage / API 变更 |
| Vite / Rolldown 版本 | 每季度 | 新 Release | **01**, 23 | 01 已整合 Vite 6.3 + Rolldown；23 为进阶附录 |
| TypeScript 版本 | 每季度 | 新 Release | **04**, 24 | 04 已整合 TS 5.8+ 深度融合；24 为进阶附录 |
| 浏览器标准 | 每半年 | 新 Chrome/FF/Safari | 22 | 更新渲染管线 / INP |
| 外部链接可用性 | 每季度 | — | SOURCE_REFERENCE_INDEX | 验证并修复死链 |
| 社区反馈整合 | 每月 | Issue/PR/评论 | 全部 | 更新内容或 FAQ |
| 英文版翻译 | 按需 | 社区需求 | 01-25 | 创建 en/ 子目录 |
