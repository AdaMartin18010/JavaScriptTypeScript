...
const GITHUB_WEB_BASE = `https://github.com/sveltejs/svelte/blob/${SVELTE_TAG}`;
 ...
 */
async function main() {
  const target = process.argv[2] || resolve(__dirname, '..');
