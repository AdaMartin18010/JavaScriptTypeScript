---
title: 'Edge 安全与零信任架构'
description: 'Edge Security and Zero Trust Architecture: JWT, mTLS, WAF, DDoS mitigation, TEE confidential computing'
---
...
**容量攻击吸收**：Anycast 路由将攻击流量分散到数百个 PoP；上游清洗中心过滤恶意流；Remote Triggered Black Hole（RTBH）作为最后手段丢弃流量。
