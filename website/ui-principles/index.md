...
- **[UI/UX 理论研究](../30-knowledge-base/30.8-research/tsjs-stack-panorama-2026/UI_UX_THEORY.md)** — 认知负荷理论、Fitts定律、视觉层次与信息架构的形式化分析，为专题中的交互设计、可用性测试与可访问性工程提供心理学基础。
- **[前端框架理论深度研究](../30-knowledge-base/30.8-research/tsjs-stack-panorama-2026/FRONTEND_FRAMEWORK_THEORY.md)** — 组件模型、设计系统与响应式布局的形式化推导，直接支撑设计令牌（Design Tokens）与跨平台UI一致性的工程实践。
